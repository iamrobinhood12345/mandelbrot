# based on https://www.youtube.com/watch?v=KeW5YgIc4UY
...
class Mandelbrot:
    ...
    def __init__(s, win_dims, max_iter, threshold, center, x_range, color_algorithm, color_multiplier, palettes,
                 current_palette):
    ...
    def _get_color_index(s, abs_val, iter_count):
        ...
        if (s.color_algorithm == 0):
            return 1 / temp_index * s.color_multiplier  # Alg 0
        else:
            return temp_index * s.color_multiplier / 500  # Alg 1
    ...
    def draw(s, surface):
        ...
        for z, iter_count in mand:
            ...
            if abs_val <= 2:
                ...
                pix_color = s._get_color(s.palettes[s.current_palette][0], s.palettes[s.current_palette][1],
                                         color_index)
...
def main():
    palettes = (
        ...
        (((255, 255, 0), (0, 255, 255), (255, 0, 255), (255, 255, 0)),  # Cotton Candy
         (0, 0.33, 0.66, 1)),
        (((255, 0, 0), (255, 128, 0), (255, 255, 0), (0, 255, 0), (0, 255, 255), (0, 68, 255), (255, 0, 255),
          (255, 0, 0)),  # Rainbow-ish
